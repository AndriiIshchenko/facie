...
Standalone module that doesn't depend on app module.
"""
import logging
...
def setup_logging(service_name: str = "bot") -> None:
    """
    Setup centralized logging for the bot.

    Args:
        service_name: Name of the service (default: "bot")
    """
    # Get root logger
